...
public class CMSearchedClassHolder extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    //todo complete
    ...
    public void onRefresh() {
        ...
        new AsyncTask<Void, Void, List<Class>>() {
            ...
            protected List<Class> doInBackground(Void... voids) {
                return Users.sharePreferenceLoad(CMSearchedClassHolder.this.getContext()).CreatedClasses();
            }
